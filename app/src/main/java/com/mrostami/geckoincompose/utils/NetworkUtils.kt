...
object NetworkUtils {
    ...
    fun isConnected(): Boolean {
        ...
        val mConnectivityMgr: ConnectivityManager? = GeckoinApplication.getInstance().getAppContext().getSystemService(Context.CONNECTIVITY_SERVICE) as? ConnectivityManager
